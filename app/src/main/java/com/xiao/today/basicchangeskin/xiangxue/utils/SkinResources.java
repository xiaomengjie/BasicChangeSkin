package com.xiao.today.basicchangeskin.xiangxue.utils;
...
public class SkinResources {
    ...
    public int getColor(int resId){
        ...
        return ResourcesCompat.getColor(mSkinResources, skinId, null);
    }
    ...
    public Drawable getDrawable(int resId) {
        ...
        return ResourcesCompat.getDrawable(mAppResources, skinId, null);
    }
